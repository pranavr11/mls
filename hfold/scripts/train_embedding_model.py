...
def main():
    ...
    artifacts = train_embedding_model(config=config, dataset=dataset, backbone_dims={"pythia": args.hidden_size, "gpt2": args.hidden_size})
    print({"final_loss": artifacts.final_loss})
